...
export default function IngUpload({ bedrijf, hex, onSuccess }: Props) {
  ...
  return (
    <div className="card">
      <h3 className="font-semibold text-slate-700 mb-1">ING Bankafschrift uploaden</h3>
      <p className="text-[11px] text-slate-400 mb-3">
        Download je bankafschrift via Mijn ING → Rekeningen → Export (.xlsx of .csv).
        BTW wordt automatisch berekend per leverancier.
      </p>
      ...
      >
        {bezig ? (
          ...
          <>
            ...
            <p className="text-sm font-medium text-slate-600">Sleep bestand hier of klik om te selecteren</p>
            <p className="text-[11px] text-slate-400 mt-1">.xlsx of .csv export van ING internetbankieren</p>
          </>
        )}
      </div>
